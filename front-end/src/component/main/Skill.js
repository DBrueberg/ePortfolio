                    ...
                    <ul>
                        <li className="mt-2">
                            ...
                            <ul style={{ fontSize: "small" }}>
                                <li>Java, React, HTML, CSS, JavaScript, SQL</li>
                            </ul>
                        </li>
                        <li className="mt-2">
                            Framework
                        ...
                        <li className="mt-2">
                            ...
                            <ul style={{ fontSize: "small" }}>
                                <li>
                                    React-Redux, Redux-Thunk, React-Bootstrap,
                                    MDB-React, Axios, Sequelize
                                </li>
                            </ul>
                        </li>
                        <li className="mt-2">
                            ...
                            <ul style={{ fontSize: "small" }}>
                                <li>
                                    Visual Studio Code, IntelliJ, Eclipse, Wing
                                    Personal, MySQL Workbench
                                </li>
                            </ul>
                        </li>
                        <li className="mt-2">
