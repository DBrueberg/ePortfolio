            ...
            >
                ...
                <li className="mb-2">
                    ...
                    <ul>
                        <li>2005-2007</li>
                        <li>
                            Studied many branches of science that revolved
                            around biology including virology, plant morphology,
                            and mammalogy
                        </li>
                    </ul>
                </li>
                ...
                <li className="mb-2">
                    ...
                    <ul>
                        <li>1999-2003</li>
                        <li>
                            Studied a vast array of science related subjects
                            including programming in C++
                        </li>
                    </ul>
                </li>
            </MDBTypography>
